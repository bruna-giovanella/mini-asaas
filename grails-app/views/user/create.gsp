<g:applyLayout name="main">
    ...
    <atlas-page-header page-name="Novo Usuário"></atlas-page-header>
    ...
    <atlas-panel>
        <atlas-text size="lg" bold>Criar Novo Usuário</atlas-text>
        ...
        <g:form controller="user" action="save" method="post">
            <atlas-grid>
                ...
                <atlas-row>
                    <atlas-col>
                        ...
                        <g:passwordField name="password" class="form-control" placeholder="Digite a senha" required="true"/>
                    </atlas-col>
                </atlas-row>
                ...
                <atlas-row>
                    <atlas-col>
                        ...
                        <atlas-text size="sm">${customer?.name ?: 'N/A'}</atlas-text>
            ...
            <atlas-layout gap="2" inline>
                <g:submitButton name="save" value="Salvar Usuário" class="btn btn-primary"/>
